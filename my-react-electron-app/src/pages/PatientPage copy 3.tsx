...
const PatientPage = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 128; i++) {
      ...
      ctImages.push(`/predictions/pt_1-images/ct/ct_slice_${formattedIndex}.png`);
      doseImages.push(`/predictions/pt_1-images/dose/dose_slice_${formattedIndex}.png`);
      predictionImages.push(`/predictions/pt_1-images/prediction/prediction_slice_${formattedIndex}.png`);
    }
